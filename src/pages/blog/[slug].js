          ...
          <div>
            {loading ? (
              ...
              <article className="w-3/4">
                <div name="Article Header" className="w-3/4">
                  <img src={blog.image} className="rounded-xl shadow-md mb-5 w-3/4"></img>
                  <h1 className="text-3xl font-semibold break-words">
                    {blog.name}
                  </h1>
                  <Date dateString={blog._createdAt}></Date>
                  <Divider class />
                </div>
                <div className="text-gray-800 w-3/4 break-words">
